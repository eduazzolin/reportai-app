...
![logo](https://github.com/user-attachments/assets/6d527cd4-68e8-4b5d-819c-eec525a6d089)

Trabalho de conclusão do curso de Análise e Desenvolvimento de Sistemas<br/>
Senac Florianópolis–SC, 2025<br/>
Este repositório contém o código do front-end do sistema "Reportaí", desenvolvido com React-JS. O back-end está disponível no repositório [reportai-server](https://github.com/eduazzolin/reportai-server).
